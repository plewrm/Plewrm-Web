                        ...
                        <div className="row g-5">
                            <div className="col-xxl-4 col-lg-4 col-12 d-flex">
                                <div className="text-center card-box shadow rounded-2 p-5">
                                    ...
                                    <p className='mb-5'>Social media are interactive technologies that facilitate the creation and sharing of information, ideas, interests, and other forms of expression through virtual communities and networks.</p>
                            ...
                            <div className="col-xxl-4 col-lg-4 col-12 d-flex">
                                <div className="text-center card-box shadow rounded-2 p-5">
                                    ...
                                    <p className='mb-5'>As Boyd also describes, when Facebook initially launched in 2004, it solely targeted college students and access was intentionally limited.</p>
                                    <div className="d-flex justify-content-center align-items-center">
                                        <a href='#services'>
                                            <FontAwesomeIcon icon={faArrowAltCircleRight} />
                                        </a>
                            ...
                            <div className="col-xxl-4 col-lg-4 col-12 d-flex">
                                <div className="text-center card-box shadow rounded-2 p-5">
                                    ...
                                    <h4 className="my-3 fw-normal">Share Easily</h4>
                                    <p className='mb-5'>The term social in regard to media suggests that platforms are user-centric and enable communal activity.</p>
                                    <div className="d-flex justify-content-center align-items-center">
                                        <a href='#services'>
                                            <FontAwesomeIcon icon={faArrowAltCircleRight} />
                                        </a>
